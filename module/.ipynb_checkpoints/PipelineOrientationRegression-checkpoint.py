...
def train(name, participant, clf, train_x, train_y, test_x, test_y):
    ...
    f1Score = 0#metrics.f1_score(test_y, predict_y, pos_label="relax")
    ...
    return name, participant, score, conMatrix, f1Score, videoScores, videof1Score, importances, report, None, test_y, predict_y
